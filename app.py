...
def create():
    if request.method == "POST":
        ...
        for card in temp_deck:
            ...
            person = request.form.get(f"{temp_deck.std_card_id}-person") or ""
            action = request.form.get(f"{temp_deck.std_card_id}-action") or ""
            obj = request.form.get(f"{temp_deck.std_card_id}-obj") or ""
