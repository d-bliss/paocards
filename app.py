...
def create():
    ...
    if request.method == "POST":
        ...
        for card in temp_deck:
            ...
            db.execute("INSERT INTO custom_cards (user_id, std_card_id, cust_card_id, person, action, obj) VALUES (?,?,?,?,?,?)", (session["user_id"], card.std_card_id, cust_card_id, person, action, obj))
